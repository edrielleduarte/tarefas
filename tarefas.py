...
def main():
    ...
    casa.add(TarefaRecorrente('Trocar lençois', datetime.now(), 6))
    ...
    # mercado.add('Carne vermelha')
    # mercado.add('Whey protein')
    # print(mercado)
    #
    # mercado.procurar('Whey protein').concluir()
    # mercado.procurar('Carne vermelha').concluir()
